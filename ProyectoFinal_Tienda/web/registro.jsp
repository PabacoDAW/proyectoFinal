    ...
    <body>
        ...
        <div class="responsive-form">
            <form class="form" method="post"> 
                ...
                <div class="field">
                    <input autocomplete="off" placeholder="Apellidos" class="input-field" type="text" id="apellidos" name="apellidos" required>
                </div>

                <div class="field">
                    <input autocomplete="off" placeholder="Email" class="input-field" type="email" id="email" name="email" required>
                </div>

                <div class="field">
                    <input autocomplete="off" placeholder="Usuario" class="input-field" type="text" id="usuario" name="usuario" required>
                </div>

                <div class="field">
                    <input placeholder="Contraseña" class="input-field" type="password" id="contrasena" name="contrasena" required>
                </div>

                <div class="field">
                    <input autocomplete="off" placeholder="Domicilio" class="input-field" type="text" id="domicilio" name="domicilio">
                </div>

                <div class="btn">
                    <input type="submit" class="button1" value="Registrar">
                    <a href="./Login" class="button2">Logearse</a>
                </div>
