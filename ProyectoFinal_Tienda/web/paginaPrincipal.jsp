...
<html>
    ...
    <body>
        ...
        <section class="banner">
            <h2>Bienvenido PaCoTech</h2>
            <p>Encuentra las mejores ofertas en productos de todo tipo</p>
        </section>
        <form method="POST">
        ...
        <footer>
            <p>&copy; 2024 PaCotech Tienda Online. Todos los derechos reservados.</p>
            <span>Para mas información contacta con nosotros mediante nuestro correo pacotech@gmail.com</span>
        </footer>
