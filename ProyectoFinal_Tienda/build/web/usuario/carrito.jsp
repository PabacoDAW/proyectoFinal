...
<html>
    ...
    <body>
            ...
            <c:forEach items="${productos}" var="producto">
                <div class="cart-item">
                    ...
                    <div class="cart-item-details">
                        ...
                        <p class="cart-item-quantity">Descripción: ${producto.descripcion}</p>
        ...
        <c:if test="${not empty productos}">
            <div class="d-flex justify-content-between pedir">
                <form class="d-flex justify-content-end">
                    <input name="eliminar" type="submit" class="btn btn-danger" value="Eliminar">
                </form>
                <form class="d-flex justify-content-start">
                    <input name="pedir" type="submit" class="btn btn-success" value="Pedir">
                </form>
            </div>
        </c:if>
